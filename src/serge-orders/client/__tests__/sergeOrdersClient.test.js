...
const paths = {
  SergeOrdersClient: "../src/sergeOrdersClient"
};
const SergeOrdersClient = require(paths.SergeOrdersClient);
const baseUri = "http://localhost";
const authToken = "auth";

describe("SergeOrdersClient", () => {
  ...
  describe("for getAll()", () => {
    ...
    it("retrieves authentication", async () => {
      ...
      let client = new SergeOrdersClient(baseUri, auth);
